...
<body style="background-color: white;"><br>
	...
	<h2 style="text-align: center;color: darkred;">Edit Information</h2>
	<?php
	...
	<div class="profile_info" style="text-align: center;">
		<span style="color: darkred;">Welcome,</span>	
		<h4 style="color: darkred;"><?php echo $_SESSION['login_user']; ?></h4>
	</div><br><br>
	...
	<div class="form1">
		...
		<div style="padding-left: 100px;">
			<button class="btn btn-default" type="submit" name="submit" style="background-color: #F6E4D9;">save</button></div>
	</form>
</div>
	<?php 
