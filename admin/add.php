...
<div id="main"><br>
  <span style="font-size:30px;cursor:pointer; color: #880808;" onclick="openNav()">&#9776; open</span>
  <div class="container" style="text-align: center;">
    <h2 style="color:#880808; font-family: Lucida Console; text-align: center"><b>Add New Books</b></h2>
    ...
    <form class="book" action="" method="post">
        ...
        <button style="text-align: center; background-color: #F6E4D9;" class="btn btn-default" type="submit" name="submit">ADD</button>
    </form>
  </div>
<?php
