...
<html>
<head>
	<title> Teacher Fine Calculation </title>
...
<div class="container">
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="search" placeholder="Teacher username.." required="">
	...
	<?php
		...
		if(isset($_POST['submit']))
		{
			...
			{
				echo "Sorry! No teacher found with that username. Try searching again.";
			}
			else
			{
